...
function cm.fselect(g,lv,c)
	...
	return g:GetSum(Card.GetLevel)==lv and g:GetCount()>=2 and Duel.GetLocationCountFromEx(tp,tp,g,c)>0 and g:IsExists(Card.IsType,1,nil,TYPE_SYNCHRO)
end
...
function cm.negcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp==1-tp and (Duel.IsExistingMatchingCard(cm.filter2,tp,LOCATION_REMOVED,0,3,nil) or c:IsAbleToRemove(tp,POS_FACEDOWN)) and (b1 or b2 or b3)
end
