...
function c94010.spcon(e,tp)
	return Duel.GetLocationCount(tp,LOCATION_SZONE)>1 and Duel.IsExistingMatchingCard(c94010.spfilter2,tp,LOCATION_MZONE+LOCATION_HAND,0,1,c) and Duel.CheckReleaseGroupEx(tp,c94010.spfilter1,2,nil) and 
