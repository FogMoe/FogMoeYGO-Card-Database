...
function cm.initial_effect(c)
	...
	e6:SetCode(EFFECT_INDESTRUCTABLE_EFFECT+EFFECT_CANNOT_BE_EFFECT_TARGET)
...
function c94020.cfilter(c,tp)
	return c:IsType(TYPE_MONSTER) and c:IsPreviousLocation(LOCATION_MZONE+LOCATION_HAND) and c:GetPreviousControler()==tp and c:IsType(TYPE_NORMAL)
end
