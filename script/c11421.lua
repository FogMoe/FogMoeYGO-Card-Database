...
function cm.shop(e,tp,eg,ep,ev,re,r,rp)
	...
	if p~=tp and (ph==PHASE_MAIN1 or ph==PHASE_MAIN2) and 0==1 and #sg>0 and Duel.GetLocationCount(tp,LOCATION_MZONE,tp,LOCATION_REASON_CONTROL)>0 and Duel.SelectYesNo(tp,aux.Stringid(m,1)) then
