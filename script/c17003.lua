...
function cm.initial_effect(c)
	...
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFun(c,17000,aux.FilterBoolFunction(Card.IsAttribute,ATTRIBUTE_DARK),1,true,true )   
	--lv
...
function cm.starlight_fusion_check(tp,sg,fc)
	return aux.gffcheck(sg,Card.IsFusionCode,17000,Card.IsAttribute,ATTRIBUTE_DARK)
end
