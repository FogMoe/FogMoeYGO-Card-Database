...
function cm.cfilter(c,tp)
	return c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_MZONE) and c:IsSetCard(0x3544) and c:IsReason(REASON_BATTLE)
end
...
function cm.filter(c,e,tp)
	return c:IsSetCard(0x3544) and c:IsLevel(1) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_ATTACK)
end
